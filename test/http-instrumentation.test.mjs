...
// Stub minimal browser-ish globals so the react client's other
// auto-instrumenters don't blow up at init.
...
// Disable other auto-instrumenters so this test focuses on HTTP only.
const _origInit = AllStak.init.bind(AllStak);
AllStak.init = (cfg) => _origInit({
